...
set(CMAKE_CXX_LINK_EXECUTABLE "${CMAKE_CXX_COMPILER} --sysroot=${CMAKE_SYSROOT} <FLAGS> <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES> ${TOOLCHAIN_PATH}/usr/lib/libc++abi.a ${TOOLCHAIN_PATH}/usr/lib/librt.a")
